...
public class Level4 extends GameLevel {
    ...
    public Level4(Game game){
        ...
        // Add the Rover
        getRover().setPosition(new Vec2(0, -10));
        // Add the Redstone
        getRedstone().setPosition(new Vec2(2,12));
        ...
        for (int i = 0; i < 3; i++) {
            ...
            ground.addImage(new BodyImage("data/mars_ground2.png", 4f));
        ...
        diamond = new Diamond(this);
        diamond.setPosition(new Vec2(12,0));
        diamond = new Diamond(this);
