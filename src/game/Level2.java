...
public class Level2 extends GameLevel {
    ...
    public Level2(Game game){
        ...
        // Add the Redstone
        getRedstone().setPosition(new Vec2(0,10));
        ...
        for (int i = 0; i < 3; i++) {
            ...
            ground.addImage(new BodyImage("data/moon_ground2.png", 4f));
        ...
        // Make a platform
        Shape platform1Shape = new BoxShape(0.7f, 2f);
        StaticBody platform1 = new StaticBody(this, platform1Shape);
        platform1.setPosition(new Vec2(0.3f, -9f));
        // Make a platform
        Shape platform2Shape = new BoxShape(0.7f, 5f);
        StaticBody platform2 = new StaticBody(this, platform2Shape);
        platform2.setPosition(new Vec2(5f, -9f));
        // Make a platform
        Shape platform3Shape = new BoxShape(0.7f, 8f);
        ...
        platform4.setPosition(new Vec2(0.5f, 1f));
        // Make a platform
        Shape platform5Shape = new BoxShape(2f, 0.5f);
        StaticBody platform5 = new StaticBody(this, platform5Shape);
        platform5.setPosition(new Vec2(-5f, -3f));
        // Make a platform
        Shape platform6Shape = new BoxShape(2f, 0.5f);
        StaticBody platform6 = new StaticBody(this, platform6Shape);
        platform6.setPosition(new Vec2(-12f, 4f));
        // Make a platform
        Shape platform7Shape = new BoxShape(1.5f, 0.5f);
        StaticBody platform7 = new StaticBody(this, platform7Shape);
        platform7.setPosition(new Vec2(0f, 9f));


        // Add the loot
        diamond = new Diamond(this);
        diamond.setPosition(new Vec2(-5,-10));
        diamond = new Diamond(this);
        diamond.setPosition(new Vec2(10,-1));
        diamond = new Diamond(this);
        diamond.setPosition(new Vec2(0.3f,2));
        diamond = new Diamond(this);
        diamond.setPosition(new Vec2(-12,5));

        // Add an Ender-Eye (Bonus Loot)
        enderEye = new EnderEye(this);
        enderEye.setPosition(new Vec2(-5f,-2));
    }

    // Condition for level completion
    public boolean isComplete() {
        if (getRover().getDiamondCount() == 4)
            return true;
        else
            return false;
    }
